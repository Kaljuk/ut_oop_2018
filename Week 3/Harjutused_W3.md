...
Kasutage käsureal sisestatud kaustanime. Loo sellest Path objekt, kasutades Paths.get meetodit. Käsurea parameetritest oli juttu ka 2. praktikumis.
...
Comparator liidese javadoc: https://docs.oracle.com/javase/8/docs/api/java/util/Comparator.html
...
Muutke visitFile meetodit, nii et iga külastatud fail lisatakse failiNimed listi. Path objekti võib sõneks teisendada, kasutades toString meetodit. Ärge siin meetodis midagi ekraanile väljasta.
